...
enum EvalDetectionParameter_ScoreType {
...
const EvalDetectionParameter_ScoreType EvalDetectionParameter_ScoreType_ScoreType_MIN = EvalDetectionParameter_ScoreType_OBJ;
const EvalDetectionParameter_ScoreType EvalDetectionParameter_ScoreType_ScoreType_MAX = EvalDetectionParameter_ScoreType_MULTIPLY;
const int EvalDetectionParameter_ScoreType_ScoreType_ARRAYSIZE = EvalDetectionParameter_ScoreType_ScoreType_MAX + 1;

const ::google::protobuf::EnumDescriptor* EvalDetectionParameter_ScoreType_descriptor();
inline const ::std::string& EvalDetectionParameter_ScoreType_Name(EvalDetectionParameter_ScoreType value) {
  return ::google::protobuf::internal::NameOfEnum(
    EvalDetectionParameter_ScoreType_descriptor(), value);
}
inline bool EvalDetectionParameter_ScoreType_Parse(
    const ::std::string& name, EvalDetectionParameter_ScoreType* value) {
  return ::google::protobuf::internal::ParseNamedEnum<EvalDetectionParameter_ScoreType>(
...
class SolverParameter : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:caffe.SolverParameter) */ {
 public:
  ...
  void clear_stagelr();
  static const int kStagelrFieldNumber = 50;
  ...
  static const int kStageiterFieldNumber = 51;
  ::google::protobuf::int32 stageiter(int index) const;
  void set_stageiter(int index, ::google::protobuf::int32 value);
  void add_stageiter(::google::protobuf::int32 value);
  const ::google::protobuf::RepeatedField< ::google::protobuf::int32 >&
      stageiter() const;
  ::google::protobuf::RepeatedField< ::google::protobuf::int32 >*
      mutable_stageiter();
 ...
 private:
  ...
  ::google::protobuf::RepeatedField< float > stagelr_;
  ::google::protobuf::RepeatedField< ::google::protobuf::int32 > stageiter_;
...
class LayerParameter : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:caffe.LayerParameter) */ {
 public:
  ...
  // optional .caffe.DetectionLossParameter detection_loss_param = 200;
  bool has_detection_loss_param() const;
  void clear_detection_loss_param();
  static const int kDetectionLossParamFieldNumber = 200;
  const ::caffe::DetectionLossParameter& detection_loss_param() const;
  ::caffe::DetectionLossParameter* mutable_detection_loss_param();
  ::caffe::DetectionLossParameter* release_detection_loss_param();
  void set_allocated_detection_loss_param(::caffe::DetectionLossParameter* detection_loss_param);

  // optional .caffe.EvalDetectionParameter eval_detection_param = 201;
  bool has_eval_detection_param() const;
  void clear_eval_detection_param();
  static const int kEvalDetectionParamFieldNumber = 201;
  const ::caffe::EvalDetectionParameter& eval_detection_param() const;
  ::caffe::EvalDetectionParameter* mutable_eval_detection_param();
  ::caffe::EvalDetectionParameter* release_eval_detection_param();
 ...
 private:
  ...
  inline void set_has_detection_loss_param();
  inline void clear_has_detection_loss_param();
  inline void set_has_eval_detection_param();
  inline void clear_has_eval_detection_param();
  ...
  ::caffe::DetectionLossParameter* detection_loss_param_;
...
class DetectionLossParameter : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:caffe.DetectionLossParameter) */ {
 public:
  DetectionLossParameter();
  virtual ~DetectionLossParameter();

  DetectionLossParameter(const DetectionLossParameter& from);

  inline DetectionLossParameter& operator=(const DetectionLossParameter& from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static const ::google::protobuf::Descriptor* descriptor();
  static const DetectionLossParameter& default_instance();

  void Swap(DetectionLossParameter* other);

  // implements Message ----------------------------------------------

  inline DetectionLossParameter* New() const { return New(NULL); }

  DetectionLossParameter* New(::google::protobuf::Arena* arena) const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  void CopyFrom(const DetectionLossParameter& from);
  void MergeFrom(const DetectionLossParameter& from);
  void Clear();
  bool IsInitialized() const;
  ...
  void SharedDtor();
  void SetCachedSize(int size) const;
  void InternalSwap(DetectionLossParameter* other);
  private:
  inline ::google::protobuf::Arena* GetArenaNoVirtual() const {
    return _internal_metadata_.arena();
  }
  ...
  static const int kNumObjectFieldNumber = 3;
  ::google::protobuf::uint32 num_object() const;
  void set_num_object(::google::protobuf::uint32 value);

  // optional float object_scale = 4 [default = 1];
  bool has_object_scale() const;
  void clear_object_scale();
  static const int kObjectScaleFieldNumber = 4;
  ...
  static const int kNoobjectScaleFieldNumber = 5;
  float noobject_scale() const;
  void set_noobject_scale(float value);

  // optional float class_scale = 6 [default = 1];
  bool has_class_scale() const;
  void clear_class_scale();
  static const int kClassScaleFieldNumber = 6;
  ...
  static const int kCoordScaleFieldNumber = 7;
  ...
  bool has_sqrt() const;
  void clear_sqrt();
  static const int kSqrtFieldNumber = 8;
  bool sqrt() const;
  ...
  static const int kConstriantFieldNumber = 9;
 ...
 private:
  ...
  inline void set_has_num_object();
  inline void clear_has_num_object();
  ...
  inline void set_has_sqrt();
  inline void clear_has_sqrt();
  inline void set_has_constriant();
  inline void clear_has_constriant();
  ...
  ::google::protobuf::uint32 num_object_;
  float object_scale_;
  ...
  void InitAsDefaultInstance();
  static DetectionLossParameter* default_instance_;
};
// -------------------------------------------------------------------

class EvalDetectionParameter : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:caffe.EvalDetectionParameter) */ {
 public:
  EvalDetectionParameter();
  virtual ~EvalDetectionParameter();
  ...
  void Swap(EvalDetectionParameter* other);

  // implements Message ----------------------------------------------

  inline EvalDetectionParameter* New() const { return New(NULL); }

  EvalDetectionParameter* New(::google::protobuf::Arena* arena) const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  ...
  static const ScoreType OBJ =
    EvalDetectionParameter_ScoreType_OBJ;
  static const ScoreType PROB =
    EvalDetectionParameter_ScoreType_PROB;
  static const ScoreType MULTIPLY =
  ...
  static inline const ::std::string& ScoreType_Name(ScoreType value) {
    return EvalDetectionParameter_ScoreType_Name(value);
  }
  ...
  bool has_sqrt() const;
  void clear_sqrt();
  static const int kSqrtFieldNumber = 5;
  bool sqrt() const;
  void set_sqrt(bool value);
  ...
  bool has_constriant() const;
  void clear_constriant();
  static const int kConstriantFieldNumber = 6;
  bool constriant() const;
  void set_constriant(bool value);
  ...
  bool has_nms() const;
  void clear_nms();
  static const int kNmsFieldNumber = 8;
  float nms() const;
 ...
 private:
  ...
  void InitAsDefaultInstance();
  static EvalDetectionParameter* default_instance_;
};
// -------------------------------------------------------------------
...
class DataParameter : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:caffe.DataParameter) */ {
 public:
  ...
  ::google::protobuf::uint32 side(int index) const;
  void set_side(int index, ::google::protobuf::uint32 value);
  void add_side(::google::protobuf::uint32 value);
  const ::google::protobuf::RepeatedField< ::google::protobuf::uint32 >&
      side() const;
  ::google::protobuf::RepeatedField< ::google::protobuf::uint32 >*
      mutable_side();
 ...
 private:
  ...
  ::google::protobuf::RepeatedField< ::google::protobuf::uint32 > side_;
...
inline ::google::protobuf::int32 SolverParameter::stageiter(int index) const {
  // @@protoc_insertion_point(field_get:caffe.SolverParameter.stageiter)
  return stageiter_.Get(index);
}
inline void SolverParameter::set_stageiter(int index, ::google::protobuf::int32 value) {
  stageiter_.Set(index, value);
  // @@protoc_insertion_point(field_set:caffe.SolverParameter.stageiter)
}
inline void SolverParameter::add_stageiter(::google::protobuf::int32 value) {
...
// optional .caffe.DetectionLossParameter detection_loss_param = 200;
inline bool LayerParameter::has_detection_loss_param() const {
  return (_has_bits_[0] & 0x00002000u) != 0;
}
inline void LayerParameter::set_has_detection_loss_param() {
  _has_bits_[0] |= 0x00002000u;
}
inline void LayerParameter::clear_has_detection_loss_param() {
  _has_bits_[0] &= ~0x00002000u;
}
inline void LayerParameter::clear_detection_loss_param() {
  if (detection_loss_param_ != NULL) detection_loss_param_->::caffe::DetectionLossParameter::Clear();
  clear_has_detection_loss_param();
}
inline const ::caffe::DetectionLossParameter& LayerParameter::detection_loss_param() const {
  // @@protoc_insertion_point(field_get:caffe.LayerParameter.detection_loss_param)
  return detection_loss_param_ != NULL ? *detection_loss_param_ : *default_instance_->detection_loss_param_;
}
inline ::caffe::DetectionLossParameter* LayerParameter::mutable_detection_loss_param() {
  set_has_detection_loss_param();
  if (detection_loss_param_ == NULL) {
    detection_loss_param_ = new ::caffe::DetectionLossParameter;
  }
  // @@protoc_insertion_point(field_mutable:caffe.LayerParameter.detection_loss_param)
  return detection_loss_param_;
}
inline ::caffe::DetectionLossParameter* LayerParameter::release_detection_loss_param() {
  // @@protoc_insertion_point(field_release:caffe.LayerParameter.detection_loss_param)
  clear_has_detection_loss_param();
  ::caffe::DetectionLossParameter* temp = detection_loss_param_;
  detection_loss_param_ = NULL;
  return temp;
}
inline void LayerParameter::set_allocated_detection_loss_param(::caffe::DetectionLossParameter* detection_loss_param) {
  delete detection_loss_param_;
  detection_loss_param_ = detection_loss_param;
  if (detection_loss_param) {
    set_has_detection_loss_param();
  } else {
    clear_has_detection_loss_param();
  }
  // @@protoc_insertion_point(field_set_allocated:caffe.LayerParameter.detection_loss_param)
}
...
inline void LayerParameter::set_has_eval_detection_param() {
  _has_bits_[0] |= 0x00004000u;
}
inline void LayerParameter::clear_has_eval_detection_param() {
  _has_bits_[0] &= ~0x00004000u;
}
inline void LayerParameter::clear_eval_detection_param() {
  if (eval_detection_param_ != NULL) eval_detection_param_->::caffe::EvalDetectionParameter::Clear();
  clear_has_eval_detection_param();
}
inline const ::caffe::EvalDetectionParameter& LayerParameter::eval_detection_param() const {
  ...
  return eval_detection_param_ != NULL ? *eval_detection_param_ : *default_instance_->eval_detection_param_;
}
inline ::caffe::EvalDetectionParameter* LayerParameter::mutable_eval_detection_param() {
  set_has_eval_detection_param();
  if (eval_detection_param_ == NULL) {
    eval_detection_param_ = new ::caffe::EvalDetectionParameter;
  }
...
// optional uint32 side = 1 [default = 7];
inline bool DetectionLossParameter::has_side() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void DetectionLossParameter::set_has_side() {
  _has_bits_[0] |= 0x00000001u;
}
inline void DetectionLossParameter::clear_has_side() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void DetectionLossParameter::clear_side() {
  side_ = 7u;
  clear_has_side();
}
inline ::google::protobuf::uint32 DetectionLossParameter::side() const {
  // @@protoc_insertion_point(field_get:caffe.DetectionLossParameter.side)
  return side_;
}
inline void DetectionLossParameter::set_side(::google::protobuf::uint32 value) {
  set_has_side();
  side_ = value;
  // @@protoc_insertion_point(field_set:caffe.DetectionLossParameter.side)
}

// optional uint32 num_class = 2 [default = 20];
inline bool DetectionLossParameter::has_num_class() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void DetectionLossParameter::set_has_num_class() {
  _has_bits_[0] |= 0x00000002u;
}
inline void DetectionLossParameter::clear_has_num_class() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void DetectionLossParameter::clear_num_class() {
  num_class_ = 20u;
  clear_has_num_class();
}
inline ::google::protobuf::uint32 DetectionLossParameter::num_class() const {
  // @@protoc_insertion_point(field_get:caffe.DetectionLossParameter.num_class)
  return num_class_;
}
inline void DetectionLossParameter::set_num_class(::google::protobuf::uint32 value) {
  set_has_num_class();
  num_class_ = value;
  // @@protoc_insertion_point(field_set:caffe.DetectionLossParameter.num_class)
}

// optional uint32 num_object = 3 [default = 2];
inline bool DetectionLossParameter::has_num_object() const {
  return (_has_bits_[0] & 0x00000004u) != 0;
}
inline void DetectionLossParameter::set_has_num_object() {
  _has_bits_[0] |= 0x00000004u;
}
inline void DetectionLossParameter::clear_has_num_object() {
  _has_bits_[0] &= ~0x00000004u;
}
inline void DetectionLossParameter::clear_num_object() {
  num_object_ = 2u;
  clear_has_num_object();
}
inline ::google::protobuf::uint32 DetectionLossParameter::num_object() const {
  // @@protoc_insertion_point(field_get:caffe.DetectionLossParameter.num_object)
  return num_object_;
}
inline void DetectionLossParameter::set_num_object(::google::protobuf::uint32 value) {
  set_has_num_object();
  num_object_ = value;
  // @@protoc_insertion_point(field_set:caffe.DetectionLossParameter.num_object)
}

// optional float object_scale = 4 [default = 1];
inline bool DetectionLossParameter::has_object_scale() const {
  return (_has_bits_[0] & 0x00000008u) != 0;
}
inline void DetectionLossParameter::set_has_object_scale() {
  _has_bits_[0] |= 0x00000008u;
}
inline void DetectionLossParameter::clear_has_object_scale() {
  _has_bits_[0] &= ~0x00000008u;
}
inline void DetectionLossParameter::clear_object_scale() {
  object_scale_ = 1;
  clear_has_object_scale();
}
inline float DetectionLossParameter::object_scale() const {
  // @@protoc_insertion_point(field_get:caffe.DetectionLossParameter.object_scale)
  return object_scale_;
}
inline void DetectionLossParameter::set_object_scale(float value) {
  set_has_object_scale();
  object_scale_ = value;
  // @@protoc_insertion_point(field_set:caffe.DetectionLossParameter.object_scale)
}

// optional float noobject_scale = 5 [default = 0.5];
inline bool DetectionLossParameter::has_noobject_scale() const {
  return (_has_bits_[0] & 0x00000010u) != 0;
}
inline void DetectionLossParameter::set_has_noobject_scale() {
  _has_bits_[0] |= 0x00000010u;
}
inline void DetectionLossParameter::clear_has_noobject_scale() {
  _has_bits_[0] &= ~0x00000010u;
}
inline void DetectionLossParameter::clear_noobject_scale() {
  noobject_scale_ = 0.5f;
  clear_has_noobject_scale();
}
inline float DetectionLossParameter::noobject_scale() const {
  // @@protoc_insertion_point(field_get:caffe.DetectionLossParameter.noobject_scale)
  return noobject_scale_;
}
inline void DetectionLossParameter::set_noobject_scale(float value) {
  set_has_noobject_scale();
  noobject_scale_ = value;
  // @@protoc_insertion_point(field_set:caffe.DetectionLossParameter.noobject_scale)
}

// optional float class_scale = 6 [default = 1];
inline bool DetectionLossParameter::has_class_scale() const {
  return (_has_bits_[0] & 0x00000020u) != 0;
}
inline void DetectionLossParameter::set_has_class_scale() {
  _has_bits_[0] |= 0x00000020u;
}
inline void DetectionLossParameter::clear_has_class_scale() {
  _has_bits_[0] &= ~0x00000020u;
}
inline void DetectionLossParameter::clear_class_scale() {
  class_scale_ = 1;
  clear_has_class_scale();
}
inline float DetectionLossParameter::class_scale() const {
  // @@protoc_insertion_point(field_get:caffe.DetectionLossParameter.class_scale)
  return class_scale_;
}
inline void DetectionLossParameter::set_class_scale(float value) {
  set_has_class_scale();
  class_scale_ = value;
  // @@protoc_insertion_point(field_set:caffe.DetectionLossParameter.class_scale)
}

// optional float coord_scale = 7 [default = 5];
inline bool DetectionLossParameter::has_coord_scale() const {
  return (_has_bits_[0] & 0x00000040u) != 0;
}
inline void DetectionLossParameter::set_has_coord_scale() {
  _has_bits_[0] |= 0x00000040u;
}
inline void DetectionLossParameter::clear_has_coord_scale() {
  _has_bits_[0] &= ~0x00000040u;
}
inline void DetectionLossParameter::clear_coord_scale() {
  coord_scale_ = 5;
  clear_has_coord_scale();
}
inline float DetectionLossParameter::coord_scale() const {
  // @@protoc_insertion_point(field_get:caffe.DetectionLossParameter.coord_scale)
  return coord_scale_;
}
inline void DetectionLossParameter::set_coord_scale(float value) {
  set_has_coord_scale();
  coord_scale_ = value;
  // @@protoc_insertion_point(field_set:caffe.DetectionLossParameter.coord_scale)
}

// optional bool sqrt = 8 [default = true];
inline bool DetectionLossParameter::has_sqrt() const {
  return (_has_bits_[0] & 0x00000080u) != 0;
}
inline void DetectionLossParameter::set_has_sqrt() {
  _has_bits_[0] |= 0x00000080u;
}
inline void DetectionLossParameter::clear_has_sqrt() {
  _has_bits_[0] &= ~0x00000080u;
}
inline void DetectionLossParameter::clear_sqrt() {
  sqrt_ = true;
  clear_has_sqrt();
}
inline bool DetectionLossParameter::sqrt() const {
  // @@protoc_insertion_point(field_get:caffe.DetectionLossParameter.sqrt)
  return sqrt_;
}
inline void DetectionLossParameter::set_sqrt(bool value) {
  set_has_sqrt();
  sqrt_ = value;
  // @@protoc_insertion_point(field_set:caffe.DetectionLossParameter.sqrt)
}

// optional bool constriant = 9 [default = false];
inline bool DetectionLossParameter::has_constriant() const {
  return (_has_bits_[0] & 0x00000100u) != 0;
}
inline void DetectionLossParameter::set_has_constriant() {
  _has_bits_[0] |= 0x00000100u;
}
inline void DetectionLossParameter::clear_has_constriant() {
  _has_bits_[0] &= ~0x00000100u;
}
inline void DetectionLossParameter::clear_constriant() {
  constriant_ = false;
  clear_has_constriant();
}
inline bool DetectionLossParameter::constriant() const {
  // @@protoc_insertion_point(field_get:caffe.DetectionLossParameter.constriant)
  return constriant_;
}
inline void DetectionLossParameter::set_constriant(bool value) {
  set_has_constriant();
  constriant_ = value;
  // @@protoc_insertion_point(field_set:caffe.DetectionLossParameter.constriant)
}
...
inline void EvalDetectionParameter::set_has_side() {
  _has_bits_[0] |= 0x00000001u;
}
inline void EvalDetectionParameter::clear_has_side() {
  _has_bits_[0] &= ~0x00000001u;
}
...
inline ::google::protobuf::uint32 EvalDetectionParameter::side() const {
  // @@protoc_insertion_point(field_get:caffe.EvalDetectionParameter.side)
  return side_;
}
inline void EvalDetectionParameter::set_side(::google::protobuf::uint32 value) {
  set_has_side();
  side_ = value;
...
inline void EvalDetectionParameter::set_has_num_class() {
  _has_bits_[0] |= 0x00000002u;
}
inline void EvalDetectionParameter::clear_has_num_class() {
  _has_bits_[0] &= ~0x00000002u;
}
...
inline ::google::protobuf::uint32 EvalDetectionParameter::num_class() const {
  // @@protoc_insertion_point(field_get:caffe.EvalDetectionParameter.num_class)
  return num_class_;
}
inline void EvalDetectionParameter::set_num_class(::google::protobuf::uint32 value) {
  set_has_num_class();
  num_class_ = value;
...
inline void EvalDetectionParameter::set_has_num_object() {
  _has_bits_[0] |= 0x00000004u;
}
inline void EvalDetectionParameter::clear_has_num_object() {
  _has_bits_[0] &= ~0x00000004u;
}
...
inline ::google::protobuf::uint32 EvalDetectionParameter::num_object() const {
  // @@protoc_insertion_point(field_get:caffe.EvalDetectionParameter.num_object)
  return num_object_;
}
inline void EvalDetectionParameter::set_num_object(::google::protobuf::uint32 value) {
  set_has_num_object();
  num_object_ = value;
...
inline void EvalDetectionParameter::set_has_threshold() {
  _has_bits_[0] |= 0x00000008u;
}
inline void EvalDetectionParameter::clear_has_threshold() {
  _has_bits_[0] &= ~0x00000008u;
}
...
inline void EvalDetectionParameter::set_has_sqrt() {
  _has_bits_[0] |= 0x00000010u;
}
inline void EvalDetectionParameter::clear_has_sqrt() {
  _has_bits_[0] &= ~0x00000010u;
}
...
inline void EvalDetectionParameter::set_has_constriant() {
  _has_bits_[0] |= 0x00000020u;
}
inline void EvalDetectionParameter::clear_has_constriant() {
  _has_bits_[0] &= ~0x00000020u;
}
...
inline void EvalDetectionParameter::set_has_score_type() {
  _has_bits_[0] |= 0x00000040u;
}
inline void EvalDetectionParameter::clear_has_score_type() {
  _has_bits_[0] &= ~0x00000040u;
}
...
inline void EvalDetectionParameter::set_has_nms() {
  _has_bits_[0] |= 0x00000080u;
}
inline void EvalDetectionParameter::clear_has_nms() {
  _has_bits_[0] &= ~0x00000080u;
}
...
inline ::google::protobuf::uint32 DataParameter::side(int index) const {
  // @@protoc_insertion_point(field_get:caffe.DataParameter.side)
  return side_.Get(index);
}
inline void DataParameter::set_side(int index, ::google::protobuf::uint32 value) {
  side_.Set(index, value);
  // @@protoc_insertion_point(field_set:caffe.DataParameter.side)
}
inline void DataParameter::add_side(::google::protobuf::uint32 value) {
  side_.Add(value);
...
// optional .caffe.DetectionLossParameter detection_loss_param = 200;
inline bool V1LayerParameter::has_detection_loss_param() const {
  return (_has_bits_[1] & 0x00000400u) != 0;
}
inline void V1LayerParameter::set_has_detection_loss_param() {
  _has_bits_[1] |= 0x00000400u;
}
inline void V1LayerParameter::clear_has_detection_loss_param() {
  _has_bits_[1] &= ~0x00000400u;
}
inline void V1LayerParameter::clear_detection_loss_param() {
  if (detection_loss_param_ != NULL) detection_loss_param_->::caffe::DetectionLossParameter::Clear();
  clear_has_detection_loss_param();
}
inline const ::caffe::DetectionLossParameter& V1LayerParameter::detection_loss_param() const {
  // @@protoc_insertion_point(field_get:caffe.V1LayerParameter.detection_loss_param)
  return detection_loss_param_ != NULL ? *detection_loss_param_ : *default_instance_->detection_loss_param_;
}
inline ::caffe::DetectionLossParameter* V1LayerParameter::mutable_detection_loss_param() {
  set_has_detection_loss_param();
  if (detection_loss_param_ == NULL) {
    detection_loss_param_ = new ::caffe::DetectionLossParameter;
  }
  // @@protoc_insertion_point(field_mutable:caffe.V1LayerParameter.detection_loss_param)
  return detection_loss_param_;
}
inline ::caffe::DetectionLossParameter* V1LayerParameter::release_detection_loss_param() {
  // @@protoc_insertion_point(field_release:caffe.V1LayerParameter.detection_loss_param)
  clear_has_detection_loss_param();
  ::caffe::DetectionLossParameter* temp = detection_loss_param_;
  detection_loss_param_ = NULL;
  return temp;
}
inline void V1LayerParameter::set_allocated_detection_loss_param(::caffe::DetectionLossParameter* detection_loss_param) {
  delete detection_loss_param_;
  detection_loss_param_ = detection_loss_param;
  if (detection_loss_param) {
    set_has_detection_loss_param();
  ...
  // @@protoc_insertion_point(field_set_allocated:caffe.V1LayerParameter.detection_loss_param)
}

// optional .caffe.EvalDetectionParameter eval_detection_param = 201;
inline bool V1LayerParameter::has_eval_detection_param() const {
  return (_has_bits_[1] & 0x00000800u) != 0;
}
inline void V1LayerParameter::set_has_eval_detection_param() {
  _has_bits_[1] |= 0x00000800u;
}
inline void V1LayerParameter::clear_has_eval_detection_param() {
  _has_bits_[1] &= ~0x00000800u;
}
inline void V1LayerParameter::clear_eval_detection_param() {
  if (eval_detection_param_ != NULL) eval_detection_param_->::caffe::EvalDetectionParameter::Clear();
  clear_has_eval_detection_param();
}
inline const ::caffe::EvalDetectionParameter& V1LayerParameter::eval_detection_param() const {
  // @@protoc_insertion_point(field_get:caffe.V1LayerParameter.eval_detection_param)
  return eval_detection_param_ != NULL ? *eval_detection_param_ : *default_instance_->eval_detection_param_;
}
inline ::caffe::EvalDetectionParameter* V1LayerParameter::mutable_eval_detection_param() {
  set_has_eval_detection_param();
  if (eval_detection_param_ == NULL) {
    eval_detection_param_ = new ::caffe::EvalDetectionParameter;
  }
  // @@protoc_insertion_point(field_mutable:caffe.V1LayerParameter.eval_detection_param)
  return eval_detection_param_;
}
inline ::caffe::EvalDetectionParameter* V1LayerParameter::release_eval_detection_param() {
  // @@protoc_insertion_point(field_release:caffe.V1LayerParameter.eval_detection_param)
  clear_has_eval_detection_param();
  ::caffe::EvalDetectionParameter* temp = eval_detection_param_;
  eval_detection_param_ = NULL;
  return temp;
}
inline void V1LayerParameter::set_allocated_eval_detection_param(::caffe::EvalDetectionParameter* eval_detection_param) {
  delete eval_detection_param_;
  eval_detection_param_ = eval_detection_param;
  if (eval_detection_param) {
    set_has_eval_detection_param();
  ...
  // @@protoc_insertion_point(field_set_allocated:caffe.V1LayerParameter.eval_detection_param)
}
...
template <> struct is_proto_enum< ::caffe::EvalDetectionParameter_ScoreType> : ::google::protobuf::internal::true_type {};
template <>
