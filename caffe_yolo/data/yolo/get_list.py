...
test12_jpeg_list = []
count = 0
for name in ["VOC2007", "VOC2012", "VOC20121"]:
  print("name -",name)
  ...
  for t in ["train.txt", "val.txt"]:
    ...
    print("file_path -",file_path,t)
    if name=="VOC20121" and t=="val.txt":
      print("not valid  ",name,t)
      continue
    ...
    # count to check how many image in one folder
    print("count -",count)
    count  = 0
  if name == "VOC2007":
...
print("final length - ",len(trainval_jpeg_list))
